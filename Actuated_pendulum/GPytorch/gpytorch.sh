...
python_script_init="/home/hansm/active_learning/Actuated_pendulum/GPytorch/init.py"
python3 $python_script_init

# Path to the loop Python script
python_script_exec="/home/hansm/active_learning/Actuated_pendulum/GPytorch/exec.py"
