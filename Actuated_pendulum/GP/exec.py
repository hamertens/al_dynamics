...
file_path_test_inputs = '/home/hansm/active_learning/Actuated_pendulum/GP/data/test_inputs.csv'
df_test_inputs = pd.read_csv(file_path_test_inputs)
test_inputs = df_test_inputs.values

file_path_test_outputs = '/home/hansm/active_learning/Actuated_pendulum/GP/data/test_outputs.csv'
df_test_outputs = pd.read_csv(file_path_test_outputs)
test_outputs = df_test_outputs.values


file_path_training_inputs = '/home/hansm/active_learning/Actuated_pendulum/GP/training_inputs_active.csv'
df_training_inputs = pd.read_csv("training_inputs_active.csv")
training_inputs = df_training_inputs.values

file_path_training_outputs = '/home/hansm/active_learning/Actuated_pendulum/GP/training_outputs_active.csv'
df_training_outputs = pd.read_csv("training_outputs_active.csv")
training_outputs = df_training_outputs.values

file_path_predictions = '/home/hansm/active_learning/Actuated_pendulum/GP/predictions.csv'
