...
FOLDER_FILEPATH = "/home/hansm/active_learning/Lorenz/BNN_cont/"
DATA_FILEPATH = "/home/hansm/active_learning/Lorenz/data/"
INPUT_DIMENSIONALITY = 3
OUTPUT_DIMENSIONALITY = 3
DATAFRAME_COLUMNS_INPUT  = ["x", "y", "z"]
DATAFRAME_COLUMNS_OUTPUT  = ["x", "y", "z"]

#name of anaconda environment
env_name = "bnn" 

ensemble_bash_filepath = "/home/hansm/active_learning/Lorenz/BNN_cont/bnn.sh"

# Path to the init Python script
python_script_init="/home/hansm/active_learning/Lorenz/BNN_cont/init.py"

# Path to the loop Python script
python_script_exec="/home/hansm/active_learning/Lorenz/BNN_cont/exec.py"
