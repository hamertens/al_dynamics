...
file_path_train_inputs = '/home/hansm/active_learning/Lorenz/BNN/data/lorenz_train_inputs.csv'
df_train_inputs = pd.read_csv(file_path_train_inputs)
train_inputs = df_train_inputs.values

file_path_train_outputs = '/home/hansm/active_learning/Lorenz/BNN/data/lorenz_train_outputs.csv'
df_train_outputs = pd.read_csv(file_path_train_outputs)
train_outputs = df_train_outputs.values

file_path_test_inputs = '/home/hansm/active_learning/Lorenz/BNN/data/lorenz_test_inputs.csv'
df_test_inputs = pd.read_csv(file_path_test_inputs)
test_inputs = df_test_inputs.values

file_path_test_outputs = '/home/hansm/active_learning/Lorenz/BNN/data/lorenz_test_outputs.csv'
df_test_outputs = pd.read_csv(file_path_test_outputs)
test_outputs = df_test_outputs.values


file_path_training_inputs = '/home/hansm/active_learning/Lorenz/BNN/training_inputs_active.csv'
df_training_inputs = pd.read_csv("training_inputs_active.csv")
training_inputs = df_training_inputs.values

file_path_training_outputs = '/home/hansm/active_learning/Lorenz/BNN/training_outputs_active.csv'
df_training_outputs = pd.read_csv("training_outputs_active.csv")
training_outputs = df_training_outputs.values

file_path_predictions = '/home/hansm/active_learning/Lorenz/BNN/predictions.csv'
...
# Check if rmse has converged

# Read the CSV file into a DataFrame
#convergence_df = pd.read_csv("/home/hansm/active_learning/Lorenz/final_convergence_rmse.csv")
# Extract the value from the DataFrame
#final_rmse = convergence_df.iloc[0, 0]

# Perform the comparison
#if RMSE > 10000000 * final_rmse:
#    result = False
#else:
#    result = True