...
def train_dropout_model(x_train, y_train, x_test, y_test, init_script=False, input_dim = INPUT_DIMENSIONALITY, output_dim = OUTPUT_DIMENSIONALITY):
  ...
  if init_script == True:
      ...
      load_path = FOLDER_FILEPATH + 'output_data/model/-2000.ckpt.index'    
  losshistory, train_state = BNN_model.train(iterations=2000, callbacks= [BNN_uncertainty], model_save_path=save_path 
