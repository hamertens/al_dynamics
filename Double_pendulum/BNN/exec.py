...
file_path_training_inputs = '/home/hansm/active_learning/Double_pendulum/BNN/training_inputs_active.csv'
df_training_inputs = pd.read_csv("training_inputs_active.csv")
training_inputs = df_training_inputs.values

file_path_training_outputs = '/home/hansm/active_learning/Double_pendulum/BNN/training_outputs_active.csv'
df_training_outputs = pd.read_csv("training_outputs_active.csv")
training_outputs = df_training_outputs.values

file_path_predictions = '/home/hansm/active_learning/Double_pendulum/BNN/predictions.csv'
...
sum_values = Y_std[:, 0] + Y_std[:, 1] + Y_std[:, 2] + Y_std[:, 3]
...
training_inputs_active_df = pd.DataFrame(training_inputs, columns=["theta1", "theta2", "omega1", "omega2"])
training_outputs_active_df = pd.DataFrame(training_outputs, columns=["theta1", "theta2", "omega1", "omega2"])
...
predictions_df = pd.DataFrame(predictions, columns=["theta1", "theta2", "omega1", "omega2"])
