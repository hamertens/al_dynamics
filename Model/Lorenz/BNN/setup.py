...
bnn_dir = os.path.join(base_dir, 'BNN')
data_dir = os.path.join(base_dir, 'data')

# Define specifications for the model and dynamic system
FOLDER_FILEPATH = bnn_dir + os.sep
...
ensemble_bash_filepath = os.path.join(bnn_dir, "bnn.sh")

# Path to the init Python script
python_script_init = os.path.join(bnn_dir, "init.py")

# Path to the loop Python script
python_script_exec = os.path.join(bnn_dir, "exec.py")
